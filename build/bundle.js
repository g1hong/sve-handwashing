var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-6pdv77");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@lg 4@lg offset-4@md 6@md 12@sm");
    			attr(div1, "class", "progress-container svelte-6pdv77");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			t4 = text("Start");
    			attr(h2, "bp", "offset-5@lg 4@lg offset-4@md 6@md 12@sm");
    			attr(h2, "class", "svelte-1pm2oqt");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "bp", "offset-5@lg 4@lg offset-4@md 6@md 12@sm");
    			attr(button, "class", "start svelte-1pm2oqt");
    			attr(div1, "bp", "grid");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			 $$invalidate(2, progress = (totalSeconds - secondsLeft) * perSecond);
    		}
    	};
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@lg 4@lg offset-4@md 6@md 12@sm" src="how_to_handwash_lge.gif" alt="how_to_handwash" class="svelte-8cnegy">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/" class="svelte-fp1sr4">
    Picture Source
  </a> 
  <a href="https://freesound.org/people/javapimp/sounds/439017/" class="svelte-fp1sr4">
    Sound Source
  </a>`;

    			t7 = space();
    			audio_1 = element("audio");
    			attr(h1, "class", "svelte-fp1sr4");
    			attr(h3, "class", "svelte-fp1sr4");
